/**
 * @file three_way_expression.cpp
 * @brief Implementation of the three way expression class.
 */

// Include header file for the FThreeWayExpression class
...
FThreeWayExpression::FThreeWayExpression(ExpressionPtr left, ExpressionPtr right)
    // Call base class constructor to initialize operands
    : AComputeExpression(std::move(left), std::move(right))
{}

ValuePtr FThreeWayExpression::Evaluate(const FContext& context) const
{
    ...
    return std::make_shared<FBooleanValue>(false);
}
