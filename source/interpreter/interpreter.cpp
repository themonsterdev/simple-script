...
#include "interpreter/interpreter.hpp"  // Include the header file for the interpreter class
#include "lexer/lexer.hpp"              // Include the header file for the lexer class
#include "parser/parser.hpp"            // Include the header file for the parser class
#include "context/context.hpp"          // Include the header file for the context objects
